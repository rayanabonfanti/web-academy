...
<div id="band" class="container text-center">
  ...
  <div class="col-sm-4"></div>
    <div class="col-sm-4">  
      <p class="text-center"><strong><?php $nome = "select * from Nome_Aluno";
                 $sqlNome = mysqli_query($conexao, $nome); 
                 $row=mysqli_fetch_assoc($sqlNome);
                 echo $row['Nome'];
             ?></strong></p><br>      

        <center><form id="altera" name="altera" action="bancoPHP/bancoAlteraDadoAluno-Senha.php" method="post"> 
